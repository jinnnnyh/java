...
public class PropertiesEx {
  public static void main(String[] args) throws Exception{
    ...
    // getPath() : 지정한 파일의 전제 경로 출력
    // getResource(파일명) : 사용할 설정파일 지정
    String path = PropertiesEx.class.getClassLoader().getResource("database.properties").getPath();
    ...
    // getProperty() : 지정한 키와 1대1로 연동된 데이터를 가져옴
